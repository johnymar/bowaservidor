...
namespace ItaSystem.DTE.Engine.Documento
{
    ...
    public class Documento
    {
        ...
        public System.Drawing.Bitmap TimbrePDF417(out string messageOut) 
        {
            ...
            try
            {
                var image = PDF417.PDF417.GetTimbreImage(XmlHandler.Serialize(TED, SerializationType.SerializationTypes.Inline, out aux, false, true, null, "out\\temp", false), out messageOut);
        ...
        public bool Timbrar(string time, string _CAFFilePath, out string message, bool escribeArchivo = false, string tempFilePath = "out\\temp\\")
        {
            ...
            TED.DatosBasicos.CAF = CAFHandler.CAFHandler.GetCAF(_CAFFilePath);
