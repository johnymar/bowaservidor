...
using static ITA_CHILE.Enum.CodigosAduana;
...
namespace ItaSystem.DTE.Engine.Documento
{
    ...
    public class IdentificacionDTE
    {
        ...
        /// </summary>
        [XmlElement("TipoDTE")]
        public Engine.Enum.TipoDTE.DTEType TipoDTE { get; set; }
        ...
        public Engine.Enum.TipoDespacho.TipoDespachoEnum TipoDespacho { get; set; }
        ...
        public Engine.Enum.TipoTraslado.TipoTrasladoEnum TipoTraslado { get; set; }
        ...
        public Engine.Enum.TipoImpresion.TipoImpresionEnum TipoImpresion { get; set; }
        ...
        [XmlElement(ElementName = "IndServicio", Type = typeof(Engine.Enum.IndicadorServicio.IndicadorServicioEnum))]
        public Engine.Enum.IndicadorServicio.IndicadorServicioEnum IndicadorServicio { get; set; }
        ...
        /// </summary>
        [XmlIgnore]
        public DateTime FechaCancelacion { get { return DateTime.Parse(FechaCancelacionString); } set { this.FechaCancelacionString = value.ToString(Config.Resources.DateFormat); } }        
        ...
        public IdentificacionDTE()
        {
            ...
            IndicadorNoRebaja = 0;
            TipoDespacho = Engine.Enum.TipoDespacho.TipoDespachoEnum.NotSet;
            TipoTraslado = Engine.Enum.TipoTraslado.TipoTrasladoEnum.NotSet;
            TipoImpresion = Engine.Enum.TipoImpresion.TipoImpresionEnum.N;
            IndicadorMontosBruto = 0;
            FormaPago = Engine.Enum.FormaPago.FormaPagoEnum.NotSet;
            ...
            MedioPago = Engine.Enum.MedioPago.MedioPagoEnum.NotSet;
            TipoCuentaPago = Engine.Enum.TipoCuentaPago.TipoCuentaPagoEnum.NotSet;
