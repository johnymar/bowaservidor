...
namespace ItaSystem.DTE.Engine.Documento
{
    public class DetalleExportacion
    {
        ...
        /// </summary>
        [XmlElement("IndExe")]
        public Enum.IndicadorFacturacionExencion.IndicadorFacturacionExencionEnum IndicadorExento { get; set; }
        public bool ShouldSerializeIndicadorExento() { return IndicadorExento != Enum.IndicadorFacturacionExencion.IndicadorFacturacionExencionEnum.NotSet; }
        ...
        /// </summary>
        [XmlIgnore]
        public DateTime FechaElaboracion { get { return DateTime.Parse(FechaElaboracionString); } set { FechaElaboracionString = value.ToString(Config.Resources.DateFormat); } }
        ...
        /// </summary>
        [XmlIgnore]
        public DateTime FechaVencimiento { get { return DateTime.Parse(FechaVencimientoString); } set { FechaVencimientoString = value.ToString(Config.Resources.DateFormat); } }
        ...
        public DetalleExportacion()
        {
            ...
            MontoItem = 0;
            CodigosItem = null;
            IndicadorExento = Engine.Enum.IndicadorFacturacionExencion.IndicadorFacturacionExencionEnum.NotSet;
            Retenedor = null;
