...
namespace ItaSystem.DTE.Engine.Documento
{
    public class OtraMoneda
    {
        ...
        public ITA_CHILE.Enum.CodigosAduana.Moneda TipoMoneda { get; set; }
        public bool ShouldSerializeTipoMoneda() { return TipoMoneda != ITA_CHILE.Enum.CodigosAduana.Moneda.NotSet; }
        ...
        public bool ShouldSerializeMontoTotal() { return MontoTotal != 0; }
        public OtraMoneda()
        {
            TipoMoneda = ITA_CHILE.Enum.CodigosAduana.Moneda.NotSet;
            MontoTotal = 0;
            TipoCambio = 0;
            MontoNeto = 0;
            MontoExento = 0;
