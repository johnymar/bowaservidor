...
namespace ItaSystem.DTE.Engine.Documento
{
    public class Extranjero
    {
        ...
        public ITA_CHILE.Enum.CodigosAduana.Paises Nacionalidad { get; set; }
        public bool ShouldSerializeNacionalidad() { return Nacionalidad != ITA_CHILE.Enum.CodigosAduana.Paises.NotSet; }

        public Extranjero()
        {
            Id = string.Empty;
            Nacionalidad = ITA_CHILE.Enum.CodigosAduana.Paises.NotSet;
        }
    }
}
