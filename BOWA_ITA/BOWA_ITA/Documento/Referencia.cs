...
namespace ItaSystem.DTE.Engine.Documento
{
    public class Referencia
    {
        ...
        /// </summary>
        [XmlIgnore]
        public DateTime FechaDocumentoReferencia { get { return DateTime.Parse(FechaDocumentoReferenciaString); } set { FechaDocumentoReferenciaString = value.ToString(Config.Resources.DateFormat); } }
