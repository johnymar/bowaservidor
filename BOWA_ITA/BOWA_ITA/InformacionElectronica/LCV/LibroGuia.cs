...
namespace ItaSystem.DTE.Engine.InformacionElectronica.LCV
{
    ...
    public class LibroGuia
    {
        ...
        public string xsiSchemaLocation = "http://www.sii.cl/SiiDte LibroGuia_v10.xsd";
        ...
        public string Firmar(string nombreCertificado, string outputDirectory, string password = "")
        {
            ...
            XML.XmlHandler.Serialize<LibroGuia>(this, XML.SerializationType.SerializationTypes.LineBreakNoIndent, out filePath, true, false, namespaces, outputDirectory);
