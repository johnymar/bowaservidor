    ...
    class Program
    {
        ...
        public static void HasRows()
        {
             ...
             try
            {
                ...
                cmd.CommandText = "SELECT rut FROM cliente_gerson where status='0' order by rut desc ";
                cmd.Prepare();
            ...
            while (true)
            {
              ...
              */
                    ...
                    try
                    {
                        ...
                        MySqlCommand cmd = new MySqlCommand();
                        cmd.Connection = conexion;
                        cmd.CommandText = "UPDATE  cliente_gerson SET status='1' WHERE rut=@rut_empresa";
                        cmd.Parameters.AddWithValue("@rut_empresa", rutempresa);
                        cmd.Prepare();
                        cmd.ExecuteNonQuery();
                ...
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand();
                    cmd.Connection = conexion;
                    cmd.CommandText = "UPDATE  cliente_gerson SET status='0' WHERE 1";
                    cmd.Parameters.AddWithValue("@rut_empresa", rutempresa);
                    cmd.Prepare();
                    cmd.ExecuteNonQuery();
                    conexion.Close();
