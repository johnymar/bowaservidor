...
namespace dte_local
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                using (StreamWriter sw = File.CreateText(@ruta+"\temp\\listo_3.txt"))
                {
        ...
        public static void firmar_boletas()
        {
                                  ...
                                  /*      string[] monto = new string[300];
                                   ...
                                   //         montox = node.InnerText;
                                    ...
                                    "( @rut, @fecha, @sucursal,@certificado,@clave) ON DUPLICATE KEY UPDATE certificado=@certificado";
                                                ...
                                                cmd.CommandText = "UPDATE  cliente_uno SET vencido='1' WHERE rut like'" +rutempresa  + "'";
            ...
            catch (Exception e)
            {
                ...
                using (StreamWriter sw = File.CreateText(@ruta+"temp/listo_3.txt"))
                {
    ...
    "fecha_final= @fecha_final, distribuidor=@distribuidor";
            ...
            catch (Exception ee)
            {
                ...
                using (StreamWriter sw = File.CreateText(@ruta + "bowa\\temp\\listo_3.txt"))
                {
